<template>
  <div class="page">
    ...
    <div class="url-info-box">
      ...
      <div class="info-item">
        <strong>Path:</strong> <code>{{ route.path }}</code>
      </div>
      <div class="info-item">
        <strong>Full Path:</strong> <code>{{ route.fullPath }}</code>
      </div>
      <div class="info-item" v-if="Object.keys(route.query).length > 0">
      ...
      <div class="info-item" v-if="route.hash">
        <strong>Hash:</strong> <code>{{ route.hash }}</code>
      </div>
      <div class="info-item" v-else>
